...
export default {
  computed: {
    // TODO: Use vue's state mapping functions for this
    cartProducts() { console.log(this.$store.getters.cartProducts); return this.$store.getters.cartProducts },
    cartTotal() { return this.$store.getters.cartPrice },
  },
  methods: {
    checkout() {
